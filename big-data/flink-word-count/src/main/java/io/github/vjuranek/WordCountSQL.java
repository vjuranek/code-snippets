 ...
 * <a href="https://github.com/apache/flink/blob/master/flink-examples/flink-examples-table/src/main/java/org/apache/flink/table/examples/java/basics/WordCountSQLExample.java">WordCountSQLExample</a>
...
public final class WordCountSQL {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Tuple2<String, Integer>> tokens = text.flatMap(new Tokenizer());
        final Table tokenTable = tEnv.fromDataStream(tokens);
